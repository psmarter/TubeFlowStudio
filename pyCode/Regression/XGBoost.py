...
if __name__ == "__main__":
    ...
    #     test_y, ypred, mse, mse_columns, models, evals_result, x_data, y_data = XGBoosttest.train_and_predict(datainputPath,
    #                                                                                               dataoutputPath,
    #                                                                                               model_save_path)
    ...
    # # 对新数据进行预测
    # if os.path.exists(model_save_path):
    #     predictions = XGBoosttest.predict_new_data(new_data_path, model_save_path)
