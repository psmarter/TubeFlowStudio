...
def train_and_predict(input_data_path, output_data_path):
    ...
    # 训练特征提取模型
    train_feature_extractor(feature_extractor, train_loader, criterion, optimizer, num_epochs=50)
    ...
    return input_data, output_data, mse, y_test_np, y_pred

def plot_predictions(test_y, ypred, output_data_path, start_idx=0, end_idx=100):
...
input_header, input_data = read_txt_file('inputdata.txt');
print(input_data)
output_header, output_data = read_txt_file('outputdata.txt');
print(output_data)