...
if __name__ == "__main__":
    ...
    # model_save_temp_path = r'C:\Users\s2\Desktop\MTSS_test\temp_model.pth'
    ...
    # else:
        # 如果不存在，则训练模型并保存
    # path = r'C:\Users\s2\Desktop\MTSS_test\1017x1\电子枪1'
    ...
    # 将model_save_temp_path的模型文件删除
    # os.remove(model_save_temp_path)
